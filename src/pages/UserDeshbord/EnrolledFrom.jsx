...
<div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
  <div className="bg-white shadow-lg rounded-2xl p-6 w-full max-w-md text-center">
    {userCheckEngrolled ? (
      <h1 className="text-green-600 font-bold text-lg">✅ User is Enrolled</h1>
    ) : userCheckApplicants ? (
      <h1 className="text-blue-600 font-bold text-lg">📌 User is Applicant</h1>
    ) : (
      <>
      ...
      {bankDetails.length > 0 ? (
        bankDetails.map((detail) => (
          ...
          >
            ...
            <p>
              <strong>Account No:</strong> {detail.accountNo}
            </p>
            <p>
